...
def excute_test(pairlist="./data/pairlist_lfw.mat", test_data="./data/lbp_lfw.mat", result_fold="./result/"):
    ...
    data_to_pkl(data, result_fold+"pca_lfw_pca.pkl")

    data = read_pkl(result_fold+"pca_lfw_pca.pkl")
    print data.shape
    ...
    data_to_pkl({"distance": dist_all, "label": label}, result_fold+"result_pca.pkl")


if __name__ == "__main__":
    excute_train()
    excute_test()
    excute_performance("./result/result_pca.pkl", -5, -1, 0.01)
